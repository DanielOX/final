  ...
  <div class="row card z-depth-3" style="margin:0 auto;width:50%">
		<div class="col card-content s12 m12 l12 ">
		 <form method="post" action="data.php" enctype="multipart/form-data">
          ...
          <input type="hidden" name="type_post" value="education">
          <br/>
				</div>
...
<br>
					<?php
											$conn = mysqli_connect("127.0.0.1", "root","","community");
											$sql3 = "SELECT * from user,education where user.user_id in (select user_id from `education`) ORDER BY education.post_id DESC";
                      ...
                      <ul class="dropdown-content" id="dropdown'.$i.'">
                      												<li>
                      													<a href="delete_post.php?id='.$row['post_id'].'&type=education">Delete</a>
                      												</li>
                                              <li>
                      													<a href="edit_post.php?id='.$row['post_id'].'&type=education">Edit</a>
                      												</li>
...
$('.liker').on('click',function(){
  ...
  http.open('GET','post_review.php?pid='+post_id_like+'&type=1&type_cat=education',true);
  http.send();
...
$('.disliker').on('click',function(){
  ...
  http.open('GET','post_review.php?pid='+post_id_like+'&type=0&type_cat=education',true);
  http.send();
