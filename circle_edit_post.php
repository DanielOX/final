...
$query = "SELECT * FROM circle_posts WHERE post_id = $post_id";
              ...
              <div class="card-body" style="padding:18px 28px">
                <form method="post" action="update_post.php" style="margin-bottom:10px"  enctype="multipart/form-data">
                   <div class="col s12 m12 l12 input-file">     <!-- upper portion of div for add photo etc-->
                      <div style="width:50px;height:50px;border-radius:100%;background-image:url('<?php if($self_user['image'] === 'AVATAR.png'){echo 'http://localhost/final/user_data/AVATAR.png';} else{ echo 'localhost/final/user_data/'.$self_user['image']; } ?>');background-size:cover;background-position:center center;" class="left"></div>
                     <div>
